"""Задание 1 Создать не менее двух дескрипторов для атрибутов классов, которые вы создали ранее в ДЗ"""
# Для второго варианта создал новый класс не из дз, т.к. хотелось проверить на строках на небольшом наглядном классе
